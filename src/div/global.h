...
// PORT: Escalado proporcional de fuentes y gr ficos (letra proporcional a la resoluci¢n)
...
/* PORT (E2.1): divpaint.cpp y divpalet.cpp llaman a funciones definidas mas
 * abajo en el propio fichero sin prototipo previo; Watcom lo toleraba y el
 * port los compila como C (/TC), donde eso da declaracion implicita y C2371.
 * El header lo genera tools/gen_protos.py y solo lo ve el target del IDE. */
#ifdef PORT_IDE
#include "port_ide_protos.h"
#endif
