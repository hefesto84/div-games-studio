...
/* PORT: declaraciones adelantadas -- se usan (linea ~20 etc.) antes de
 * definirse (lineas 82/281/318/353/390), y compilado como C estricto
 * (no C++) la declaracion implicita no coincide con la definicion real. */
