...
extern "C" {
#endif
  /* PORT (E6a): jpeglib fuera del build del IDE de momento; JPG queda
   * en stub (port_ide_stubs.c). El include arrastra el choque de
   * "boolean" con rpcndr.h y el jconfig.h es de Watcom/DOS. */
#ifndef PORT_IDE
