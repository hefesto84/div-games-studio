...
void cfg_show_cursor(void) {
  ...
  if (big) {
    switch(paint_cursor) {
      case 0: wput(v.ptr,v.an,v.al,(92+3+30)*big2,(69+3+30)*big2,19); break;
      case 1: wput(v.ptr,v.an,v.al,(92+2+30)*big2,(69+2+30)*big2,22); break;
      case 2: wput(v.ptr,v.an,v.al,(92+2+30)*big2,(69+2+30)*big2,26); break;
    }
  } else {
    switch(paint_cursor) {
        ...
        if ((ptr=(byte *)malloc(n))!=NULL) {
          ...
          if (fread(ptr,1,n,f)==n) {
            ...
            if (big2>1) {
              ...
              byte *nueva=font_corner_build(ptr,sw,sh,big2,&font_an,&font_al);
              free(ptr); ptr=nueva;
            }
            if (ptr!=NULL) {
