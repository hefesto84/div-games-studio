/* PORT: copiado de src/vpe/object.cpp. Se quitan <dos.h>/<i86.h> (no se
 * usaban de verdad, solo includes muertos) y GLOBALS/div32run/inter.h se
 * resuelve con la ruta real del port. */
#include "internal.h"
