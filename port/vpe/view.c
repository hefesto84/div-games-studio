...
//  pv->Size=size;
  ...
  // PORT: era "pv->Height*4" (asumia puntero de 4 bytes); en x64 un
  // BYTE* mide 8 -- mismo bug de WallPtrs en load.c, corregido aqui igual.
  pv->BufScan=(BYTE **)malloc(pv->Height*sizeof(BYTE *));
